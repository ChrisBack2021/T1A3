module ArgVectors
    def self.help
        puts 'Welcome to the Fitness Guru help desk. Please enter "./fitness_guru.sh" to start your new fitness journey'
        puts 'For more information on how Fitness Guru works, please enter "./fitness_guru.sh -i'
        puts 'If you are interested in the gems used to create this wonderful app, please enter "./fitness_guru -g'
    end
    ...
    def self.info
        ...
        puts 'Why is it important to shuffle the order of the list you ask?'
